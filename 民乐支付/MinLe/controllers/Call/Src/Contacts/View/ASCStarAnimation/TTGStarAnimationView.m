...
- (CALayer *)fillLayer {
    return _layers[@"favorite_selected"];
}

- (CALayer *)emptyLayer {
    return _layers[@"favorite_unselect"];
}
...
//        spark1.fillColor   = [UIColor colorWithRed:0.98 green: 0.416 blue:0.188 alpha:0.7].CGColor;
        spark1.fillColor   = MAINTHEMECOLOR.CGColor;
        spark1.strokeColor = MAINTHEMECOLOR.CGColor;
        spark1.lineWidth   = 0;
    }
    if(!layerIds || [layerIds containsObject:@"spark2"]){
        ...
        spark2.fillColor   = MAINTHEMECOLOR.CGColor;
        spark2.strokeColor = MAINTHEMECOLOR.CGColor;
        spark2.lineWidth   = 0;
    }
...
//        star_line.fillColor   = [UIColor colorWithRed:1 green: 0.416 blue:0 alpha:0.7].CGColor;
        star_line.fillColor   = MAINTHEMECOLOR.CGColor;
        star_line.strokeColor = MAINTHEMECOLOR.CGColor;
