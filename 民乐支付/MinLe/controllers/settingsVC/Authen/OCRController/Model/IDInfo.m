...
- (NSString *)toString {
    return [NSString stringWithFormat:@"身份证号:%@\n姓名:%@\n性别:%@\n民族:%@\n地址:%@\n签发机关:%@\n有效期:%@",
            _num, _name, _gender, _nation, _address, _issue, _valid];
}

- (BOOL)isOK {
    if (_num !=nil && _name!=nil && _gender!=nil && _nation!=nil && _address!=nil) {
        if (_num.length>0 && _name.length >0 && _gender.length>0 && _nation.length>0 && _address.length>0) {
            return YES;
        }
    }
