...
- (void)clearSampleBufferDelegate
{
    if (self.videoDataOutput.sampleBufferDelegate) {
        [self.videoDataOutput setSampleBufferDelegate:nil queue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)];
    }
}
